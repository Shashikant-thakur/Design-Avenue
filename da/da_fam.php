...
<body class="px-1">
    ...
    <section id="cards">
        ...
        <div class="container">
            ...
            <h1 class="text-center " id="our_fam">Our family</h1>
            <div class="row ">
                <div class="col-lg-2 col-md-4 col-sm-6 mt-2 mt-sm-0 ">
                    <img  src="./imgs/avtar28.jpg " style="width: 70%; height: auto" />
                </div>
                <div class="col-lg-2 col-md-4 col-sm-6 mt-2 mt-sm-0">
                    <img  src="./imgs/avtar28.jpg " style="width: 70%; height: auto" />
                </div>
    ...
    <!-- maps and locations -->
    <section id="cards3" style="padding:5rem 0; " style="background-color: #65BAA8;">
        <!-- 3 cards i -->
        <div class="container">
            <div>
...
<!-- <div id="footer_">
    ...
    <div class="mt-5 row p-5">
        <div class="col-xs-12 col-sm-6  col-md-3">
            <p class="fw-bold text-dark">About company</p>
            <p>Lorem ipsum</p>
            <p>Lorem ipsum</p>
            <p>Lorem ipsum</p>
            <p>Lorem ipsum</p>
